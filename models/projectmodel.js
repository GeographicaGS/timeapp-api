...
// 	this._col.update(this.parseQuery({id: id}), {deleted: false}, callback);
// }
...
// 	var col_member = this._bd.collection(project_members);
// 	col_member.update(this.parseQuery({id_proj: params.id_proj, id_user: params.id_user}), {deleted: false}, callback);
// }
